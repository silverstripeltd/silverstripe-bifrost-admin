...
System.register(["react", "silverstripe-search-admin", "react-router", "react-router-dom"], function (_export, _context) {
  ...
  var d, F, g, x, f, a, J, Q, M, X, Y, c, A, H, l, P, Z, $, k, z, B, C, j, W, w, V, E, D, I, q, N, S, t, b, v, Ee, p, T, G;
  function y(i) {
    return {
      async getEngines() {
  ...
  return {
    ...
    execute: function () {
      ...
      j = "menu-module__button_MDVWjq__100", W = "menu-module__engineItemList_MDVWjq__100", w = "menu-module__engineList_MDVWjq__100", V = "menu-module__expand_MDVWjq__100", E = "menu-module__expandContainer_MDVWjq__100", D = "menu-module__expanded_MDVWjq__100", I = "menu-module__icon_MDVWjq__100", q = "menu-module__list_MDVWjq__100", N = "menu-module__selected_MDVWjq__100", S = "menu-module__title_MDVWjq__100", t = {
        button: j,
        engineItemList: W,
        engineList: w,
        expand: V,
      ...
      _export("styles", Ee = ["index.css"]), _export("PiralContext", p = F(null)), T = d.lazy(() => _context.import("./Landing-UHNOBO5O.js")), G = d.lazy(() => _context.import("./Engine-2V6OGWUN.js"));
      (function () {
        var d = document;
        ...
        ["index.css", "Landing-7JPH2GSR.css", "Engine-2K3VNJ2E.css"].forEach(cf => {
          ;
