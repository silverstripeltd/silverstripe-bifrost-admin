...
System.register(["react", "silverstripe-search-admin", "react-router", "react-router-dom"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("styles", Ee = ["index.css"]), _export("PiralContext", p = F(null)), T = d.lazy(() => _context.import("./Landing-57445F4Y.js")), G = d.lazy(() => _context.import("./Engine-2V6OGWUN.js"));
      (function () {
        var d = document;
        ...
        ["index.css", "Landing-MWDUJBQX.css", "Engine-2K3VNJ2E.css"].forEach(cf => {
          ;
