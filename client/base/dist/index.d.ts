 ...
 */
export interface PiralEventMap extends PiralCustomEventMap, PiralCustomEventMap___1 {
 ...
 * Custom events defined outside of piral-core.
 */
export interface PiralCustomEventMap___1 {}
...
export interface PiletApiCreator {
   ...
   */
  (target: PiletMetadata___1): PiletApi___1;
}
...
export interface PiletLifecycleHooks {
   ...
   */
  loadPilet?(pilet: PiletMetadata___1): void;
  /**
 ...
 */
export type SinglePilet = SinglePiletApp & PiletMetadata___1;

/**
 * An evaluated multi pilet.
 */
export type MultiPilet = MultiPiletApp & PiletMetadata___1;
 ...
 * Defines the API accessible from pilets.
 */
export interface PiletApi___1 extends EventEmitter, PiletCustomApi___1, PiletCoreApi___1 {
  /**
   * Gets the metadata of the current pilet.
   */
  meta: PiletMetadata___1;
}
 ...
 * Describes the metadata of a pilet available in its API.
 */
export interface PiletMetadata___1 {
  /**
   * The name of the pilet, i.e., the package id.
   */
  name: string;
...
export interface SinglePiletApp {
   ...
   */
  setup(api: PiletApi___1): void | Promise<void>;
  /**
   * Optional function for cleanup.
   * @param api The API to access the application.
   */
  teardown?(api: PiletApi___1): void;
  /**
 ...
 * Custom Pilet API parts defined outside of piral-core.
 */
export interface PiletCustomApi___1 extends PiletSearchAdminApi, PiletLocaleApi, PiletDashboardApi, PiletMenuApi, PiletNotificationsApi, PiletModalsApi, PiletFeedsApi {}

/**
 * Defines the Pilet API from piral-core.
 * This interface will be consumed by pilet developers so that their pilet can interact with the piral instance.
 */
export interface PiletCoreApi___1 {
  /**
   * Gets a shared data value.
   * @param name The name of the data to retrieve.
   */
  getData<TKey extends string>(name: TKey): SharedData___1[TKey];
  /**
   * Sets the data using a given name. The name needs to be used exclusively by the current pilet.
   * Using the name occupied by another pilet will result in no change.
   * @param name The name of the data to store.
   ...
   * @returns True if the data could be set, otherwise false.
   */
  setData<TKey extends string>(name: TKey, value: SharedData___1[TKey], options?: DataStoreOptions___1): boolean;
  /**
   * Registers a route for predefined page component.
   * The route needs to be unique and can contain params.
   * Params are following the path-to-regexp notation, e.g., :id for an id parameter.
   ...
   * @param meta The optional metadata to use.
   */
  registerPage(route: string, Component: AnyComponent___1<PageComponentProps___1>, meta?: PiralPageMeta___1): RegistrationDisposer___1;
  /**
   * Unregisters the page identified by the given route.
   * @param route The route that was previously registered.
   */
   ...
   * @param defaults Optionally, sets the default values for the expected data.
   */
  registerExtension<TName>(name: TName extends string ? TName : string, Component: AnyExtensionComponent___1<TName>, defaults?: Partial<ExtensionParams___1<TName>>): RegistrationDisposer___1;
  /**
   * Unregisters a global extension component.
   * Only previously registered extension components can be unregistered.
   * @param name The name of the extension slot to unregister from.
   * @param Component The registered extension component to unregister.
   */
  unregisterExtension<TName>(name: TName extends string ? TName : string, Component: AnyExtensionComponent___1<TName>): void;
  /**
   * React component for displaying extensions for a given name.
   * @param props The extension's rendering props.
   * @return The created React element.
   */
  Extension<TName>(props: ExtensionSlotProps___1<TName>): ReactElement | null;
  /**
   * Renders an extension in a plain DOM component.
   * @param element The DOM element or shadow root as a container for rendering the extension.
   * @param props The extension's rendering props.
   * @return The disposer to clear the extension.
   */
  renderHtmlExtension<TName>(element: HTMLElement | ShadowRoot, props: ExtensionSlotProps___1<TName>): Disposable___1;
}
...
export interface PiletSearchAdminApi {
  /**
   * Registers a tile with a predefined tile components.
   * The name has to be unique within the current pilet.
   * @param name The name of the tile.
   * @param Component The component to be rendered within the SearchAdmin.
   * @param preferences The optional preferences to be supplied to the SearchAdmin for the tile.
   */
  registerTile(name: string, Component: AnyComponent___1<TileComponentProps>, preferences?: TilePreferences): RegistrationDisposer___1;
  /**
   * Registers a tile for predefined tile components.
   * @param Component The component to be rendered within the SearchAdmin.
   * @param preferences The optional preferences to be supplied to the SearchAdmin for the tile.
   */
  registerTile(Component: AnyComponent___1<TileComponentProps>, preferences?: TilePreferences): RegistrationDisposer___1;
  /**
...
export interface PiletLocaleApi {
   ...
   */
  getCurrentLanguage(cb: (currently: string) => void): Disposable___1;
  /**
...
export interface PiletDashboardApi {
   ...
   */
  registerTile(name: string, Component: AnyComponent___1<TileComponentProps___1>, preferences?: TilePreferences___1): RegistrationDisposer___1;
  /**
   * Registers a tile for predefined tile components.
   * @param Component The component to be rendered within the Dashboard.
   * @param preferences The optional preferences to be supplied to the Dashboard for the tile.
   */
  registerTile(Component: AnyComponent___1<TileComponentProps___1>, preferences?: TilePreferences___1): RegistrationDisposer___1;
  /**
   * Unregisters a tile known by the given name.
   * Only previously registered tiles can be unregistered.
   * @param name The name of the tile to unregister.
...
export interface PiletMenuApi {
   ...
   */
  registerMenu(name: string, Component: AnyComponent___1<MenuComponentProps>, settings?: MenuSettings): RegistrationDisposer___1;
  /**
   * Registers a menu item for a predefined menu component.
   * @param Component The component to be rendered within the menu.
   * @param settings The optional configuration for the menu item.
   */
  registerMenu(Component: AnyComponent___1<MenuComponentProps>, settings?: MenuSettings): RegistrationDisposer___1;
  /**
...
export interface PiletNotificationsApi {
   ...
   */
  showNotification(content: string | ReactElement<any, any> | AnyComponent___1<NotificationComponentProps>, options?: NotificationOptions): Disposable___1;
}
...
export interface PiletModalsApi {
   ...
   */
  showModal<T>(name: T extends string ? T : string, options?: ModalOptions<T>): Disposable___1;
  /**
   ...
   */
  registerModal<T>(name: T extends string ? T : string, Component: AnyComponent___1<ModalComponentProps<T>>, defaults?: ModalOptions<T>, layout?: ModalLayoutOptions): RegistrationDisposer___1;
  /**
 ...
 * Defines the shape of the data store for storing shared data.
 */
export interface SharedData___1<TValue = any> {
  [key: string]: TValue;
}
 ...
 * Defines the options to be used for storing data.
 */
export type DataStoreOptions___1 = DataStoreTarget___1 | CustomDataStoreOptions___1;

/**
 * Possible shapes for a component.
 */
export type AnyComponent___1<T> = ComponentType<T> | FirstParametersOf___1<ComponentConverters___1<T>>;

/**
 * The props used by a page component.
 */
export interface PageComponentProps___1<T extends {
  [K in keyof T]?: string;
} = {}, S = any> extends RouteBaseProps___1<T, S> {
  /**
   * The meta data registered with the page.
   */
  meta: PiralPageMeta___1;
  /**
   * The children of the page.
   */
  children: ReactNode;
 ...
 * The meta data registered for a page.
 */
export interface PiralPageMeta___1 extends PiralCustomPageMeta___1 {}

/**
 * The shape of an implicit unregister function.
 */
export interface RegistrationDisposer___1 {
  /**
   * Cleans up the previous registration.
   */
  (): void;
 ...
 * Shorthand for the definition of an extension component.
 */
export type AnyExtensionComponent___1<TName> = TName extends keyof PiralExtensionSlotMap___1 ? AnyComponent___1<ExtensionComponentProps___1<TName>> : TName extends string ? AnyComponent___1<ExtensionComponentProps___1<any>> : AnyComponent___1<ExtensionComponentProps___1<TName>>;

/**
 * Gives the extension params shape for the given extension slot name.
 */
export type ExtensionParams___1<TName> = TName extends keyof PiralExtensionSlotMap___1 ? PiralExtensionSlotMap___1[TName] : TName extends string ? any : TName;

/**
 * The props for defining an extension slot.
 */
export type ExtensionSlotProps___1<TName = string> = BaseExtensionSlotProps___1<TName extends string ? TName : string, ExtensionParams___1<TName>>;

/**
 * Can be implemented by functions to be used for disposal purposes.
 */
export interface Disposable___1 {
  /**
   * Disposes the created resource.
   */
  (): void;
...
export type TileComponentProps = BaseComponentProps___1 & BareTileComponentProps;
...
export type TileComponentProps___1 = BaseComponentProps___1 & BareTileComponentProps___1;

export interface TilePreferences___1 extends PiralCustomTilePreferences___1 {
  /**
   * Sets the desired initial number of columns.
   * This may be overridden either by the user (if resizable true), or by the dashboard.
   */
...
export interface MenuComponentProps extends BaseComponentProps___1 {}

export type MenuSettings = PiralCustomMenuSettings & PiralSpecificMenuSettings;

export type NotificationComponentProps = BaseComponentProps___1 & BareNotificationProps;
...
export type ModalComponentProps<T> = BaseComponentProps___1 & BareModalComponentProps<ModalOptions<T>>;
 ...
 * Defines the potential targets when storing data.
 */
export type DataStoreTarget___1 = "memory" | "local" | "remote";

/**
 * Defines the custom options for storing data.
 */
export interface CustomDataStoreOptions___1 {
  /**
   * The target data store. By default the data is only stored in memory.
   */
  target?: DataStoreTarget___1;
  /**
   * Optionally determines when the data expires.
   */
  expires?: "never" | Date | number;
...
export type FirstParametersOf___1<T> = {
  [K in keyof T]: T[K] extends (arg: any) => any ? FirstParameter___1<T[K]> : never;
}[keyof T];

/**
 * Mapping of available component converters.
 */
export interface ComponentConverters___1<TProps> extends PiralCustomComponentConverters___1<TProps> {
  /**
   * Converts the HTML component to a framework-independent component.
   * @param component The vanilla JavaScript component to be converted.
   */
  html(component: HtmlComponent___1<TProps>): ForeignComponent___1<TProps>;
}

/**
 * The props that every registered page component obtains.
 */
export interface RouteBaseProps___1<UrlParams extends {
  [K in keyof UrlParams]?: string;
} = {}, UrlState = any> extends ReactRouter.RouteComponentProps<UrlParams, {}, UrlState>, BaseComponentProps___1 {}

/**
 * Custom meta data to include for pages.
 */
export interface PiralCustomPageMeta___1 {}

/**
 * The props of an extension component.
 */
export interface ExtensionComponentProps___1<T> extends BaseComponentProps___1 {
  /**
   * The provided parameters for showing the extension.
   */
  params: T extends keyof PiralExtensionSlotMap___1 ? PiralExtensionSlotMap___1[T] : T extends string ? any : T;
  /**
   * The optional children to receive, if any.
   */
  children?: ReactNode;
 ...
 * The mapping of the existing (known) extension slots.
 */
export interface PiralExtensionSlotMap___1 extends PiralCustomExtensionSlotMap___1 {}

/**
 * The basic props for defining an extension slot.
 */
export interface BaseExtensionSlotProps___1<TName, TParams> {
  /**
   * The children to transport, if any.
   */
  children?: ReactNode;
   ...
   * @returns The ordered extensions.
   */
  order?(extensions: Array<ExtensionRegistration___1>): Array<ExtensionRegistration___1>;
  /**
   * Defines how the provided nodes should be rendered.
   * @param nodes The rendered extension nodes.
   * @returns The rendered nodes, i.e., an ReactElement.
 ...
 * The props that every registered component obtains.
 */
export interface BaseComponentProps___1 {
  /**
   * The currently used pilet API.
   */
  piral: PiletApi___1;
...
export interface BareTileComponentProps___1 {
  /**
   * The currently used number of columns.
   */
  columns: number;
...
export interface PiralCustomTilePreferences___1 {}
...
export interface FeedSubscriber<TItem> {
  (callback: (value: TItem) => void): Disposable___1;
}
...
export type FirstParameter___1<T extends (arg: any) => any> = T extends (arg: infer P) => any ? P : never;

/**
 * Custom component converters defined outside of piral-core.
 */
export interface PiralCustomComponentConverters___1<TProps> {}

/**
 * Definition of a vanilla JavaScript component.
 */
export interface HtmlComponent___1<TProps> {
  /**
   * Renders a component into the provided element using the given props and context.
   */
  component: ForeignComponent___1<TProps>;
  /**
   * The type of the HTML component.
   */
  type: "html";
 ...
 * Generic definition of a framework-independent component.
 */
export interface ForeignComponent___1<TProps> {
  /**
   * Called when the component is mounted.
   * @param element The container hosting the element.
   * @param props The props to transport.
   ...
   * @param locals The local state of this component instance.
   */
  mount(element: HTMLElement, props: TProps, ctx: ComponentContext___1, locals: Record<string, any>): void;
  /**
   * Called when the component should be updated.
   * @param element The container hosting the element.
   * @param props The props to transport.
   ...
   * @param locals The local state of this component instance.
   */
  update?(element: HTMLElement, props: TProps, ctx: ComponentContext___1, locals: Record<string, any>): void;
  /**
   * Called when a component is unmounted.
   * @param element The container that was hosting the element.
   * @param locals The local state of this component instance.
 ...
 * Custom extension slots outside of piral-core.
 */
export interface PiralCustomExtensionSlotMap___1 {}

/**
 * The interface modeling the registration of a pilet extension component.
 */
export interface ExtensionRegistration___1 extends BaseRegistration___1 {
  /**
   * The wrapped registered extension component.
   */
  component: WrappedComponent___1<ExtensionComponentProps___1<string>>;
  /**
   * The original extension component that has been registered.
   */
  reference: any;
 ...
 * The context to be transported into the generic components.
 */
export interface ComponentContext___1 {
  /**
   * The router-independent navigation API.
   */
 ...
 * The base type for pilet component registration in the global state context.
 */
export interface BaseRegistration___1 {
  /**
   * The pilet registering the component.
   */
  pilet: string;
...
export type WrappedComponent___1<TProps> = ComponentType<PropsWithChildren<Without___1<TProps, keyof BaseComponentProps___1>>>;
...
export interface NavigationApi___1 {
   ...
   * @returns The disposable for stopping the block.
   */
  block(blocker: NavigationBlocker___1): Disposable___1;
  /**
   * Starts listening for location changes and calls the given
   * callback with an Update when it does.
   * @param listener The function being called when the route changes.
   * @returns The disposable for stopping the block.
   */
  listen(listener: NavigationListener___1): Disposable___1;
  /**
   * Gets the current navigation / application path.
   */
  path: string;
...
export type Without___1<T, K> = Pick<T, Exclude<keyof T, K>>;

export interface NavigationBlocker___1 {
  (tx: NavigationTransition___1): void;
}

export interface NavigationListener___1 {
  (update: NavigationUpdate___1): void;
}

export interface NavigationTransition___1 extends NavigationUpdate___1 {
  retry?(): void;
}

export interface NavigationUpdate___1 {
  action: NavigationAction___1;
  location: NavigationLocation___1;
}

export type NavigationAction___1 = "POP" | "PUSH" | "REPLACE";

export interface NavigationLocation___1 {
  /**
   * The fully qualified URL incl. the origin and base path.
   */
  href: string;
